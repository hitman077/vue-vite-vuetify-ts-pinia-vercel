<template>
    <v-app id="inspire">
        <v-navigation-drawer v-model="drawer">
            ...
            <v-divider></v-divider>
            <v-list nav>
                <!-- <v-list-item prepend-icon="mdi-view-dashboard" value="dashboad" to="/dashboard">Dashboad</v-list-item> -->
...
if (localStorage.getItem('theme-store') != null) {
    theme.global.name.value = localStorage.getItem('theme-store')?.toString()
} else {
...
const toggleTheme = () => {
    ...
    localStorage.setItem('theme-store', theme.global.name.value)
}
